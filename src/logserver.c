...
/* Envoie à tous les clients SSE connectés ; retire ceux qui sont fermés. */
...
/* Envoie les headers SSE puis les entrées existantes du log, puis reste ouvert. */
static void serve_sse(int fd) {
    ...
    /* Rejoue l'historique du fichier de log */
...
int main(void) {
    ...
    pthread_t t1, t2;
    pthread_create(&t1, NULL, log_listener, NULL);
    pthread_create(&t2, NULL, http_listener, NULL);
